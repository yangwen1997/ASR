...
from resource_drop.property_drop.data_cleaning import Decoder
import re
import numpy as np
...
def get_employee_feature(statistic_day):
    ...
    try:
        ...
        print_to_log('read_dgg_business_people总共有%d条商务数据' % len(results))
    ...
    try:
        ...
        df3['login_name'] = df3['login_name'].astype('str')
